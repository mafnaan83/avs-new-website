...
import { ArrowBigDown, MoveLeft, MoveRight } from "lucide-react";
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <ArrowBigDown className="h-6 w-6 text-neutral-100 dark:text-neutral-900" />
              </button>
              <motion.p
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-56 md:h-[20rem] md:w-60 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
