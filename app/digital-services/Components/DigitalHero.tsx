        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-6">
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div>
              ...
              >
                Websites apps and marketing tailored for Dubai businesses
              </motion.h1>
              ...
              >
                JS Computers offers website development, mobile app creation,
                and digital marketing services designed to help Dubai businesses
